_Last edited: 2026-05-12 by RUL-23 (post-RUL-73/74: VP_TO_WIN bumped 3→5, eff.noop swapped for second DRAW:2 (deck depth preserved at 14); `rulso simulate` harness lands as first M4 sub-issue — bot-vs-bot quantitative design signal)_
